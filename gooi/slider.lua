...
function gooi.newSlider(params)
    ...
    local function setValue(newValue)
        local oldValue = s.value
        s.value = newValue
        if oldValue ~= newValue and s.events.v then
            s.events.v(s, newValue)
        end
    end
